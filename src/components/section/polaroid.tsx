...
const photos = [
  ...
  { id: 4, src: "/salasa-basketball-2.jpg", caption: "Laracon EU", rotate: 4 },
  {
    id: 5,
    src: "/salasa-basketball-2.jpg",
...
const InteractivePolaroid = ({ photo }: { photo: Photo }) => {
  ...
  return (
    ...
    >
      ...
      <p
        className={`mt-2 text-center text-zinc-800 text-3xl font-normal leading-none ${caveat.className}`}
